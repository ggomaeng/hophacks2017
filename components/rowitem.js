...
export default class RowItem extends Component {
    ...
    render() {
        ...
        const conversionText = converted && bitcoin ? ' to USD' : 'USD to BTC';

        const desc = description ? description : 'Transaction';
        ...
        return (
            <View style={{
                ...
                <View style={{ justifyContent: 'space-around' }}>
                    <Text style={{ fontSize: 24, color: Colors.text }}>{desc}</Text>
